      ...
      >
        ...
        <div
          ...
          <div className={"px-6 pb-6 flex flex-col"}>
            ...
            {/* Name & Role */}
            <h1 className={"text-2xl sm:text-xl md:text-3xl font-bold text-white text-center mt-4"}>Pavel Ahmmed Hridoy</h1>
            <p className={"text-slate-400 text-center mt-2 text-sm sm:text-xs md:text-base"}>Frontend Developer</p>
            ...
            <div className={"flex justify-center gap-4 sm:gap-3 md:gap-6 mt-6"}>
              {[{ icon: FaGithub, href: "https://github.com/PavelAhmmedHridoy077" },
                ...
                { icon: FaGlobe, href: "https://pavel-ahmmed-hridoy.vercel.app/" }].map((item, idx) => {
                  ...
                  return (
                    ...
                    >
                      <Icon size={24} className={"sm:w-5 sm:h-5 md:w-6 md:h-6" }/>
                    </Link>
                  );
                })}
            </div>
